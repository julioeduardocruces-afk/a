...
(function(){
    ...
    if(typeof fbq==='function'&&!sessionStorage.getItem(key)){
        var eid={!! json_encode(session('meta_capi_vc_builder', '')) !!};
        var opts=eid?{eventID:eid}:{};
        fbq('track','ViewContent',{content_name:'CV Builder Page',content_category:'ATS Optimization'},opts);
...
<div style="max-width:700px;margin:30px auto;">
    ...
    <form method="POST" action="{{ route('cv-builder.store') }}" id="cv-builder-form">
        ...
        <div class="card">
            ...
            <p style="font-size:0.85rem;color:#666;margin-bottom:12px;">Si dejas este campo vacio, generaremos automaticamente un perfil profesional basado en tu experiencia laboral.</p>
            <div class="form-group">
