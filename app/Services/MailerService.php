...
class MailerService
{
    ...
    public const DEFAULTS = [
        ...
        'email_intro' => 'Tu CV ha sido optimizado con exito utilizando inteligencia artificial especializada en sistemas ATS (Applicant Tracking System). Esto significa que tu CV ahora esta estructurado y redactado para maximizar su visibilidad ante los algoritmos de seleccion que utilizan las empresas y portales de empleo.',
...
- Palabras clave relevantes para tu industria y cargo objetivo
- Formato y estructura compatible con lectores automaticos
- Redaccion profesional orientada a resultados medibles
- Seccion de habilidades alineada con lo que buscan los reclutadores',

        'email_section_tips_title' => 'Recomendaciones para maximizar tus resultados',

        'email_section_tips_body' => '1. Actualiza tu perfil en los portales de empleo: No basta con adjuntar el CV como archivo. Es fundamental que copies la informacion de tu CV optimizado directamente en los campos del perfil de plataformas como LinkedIn, Trabajando.com, Indeed, CompuTrabajo, etc. Los algoritmos de estas plataformas leen los datos del perfil para recomendar candidatos a los reclutadores.

2. Completa TODA la informacion del perfil: Muchos postulantes solo suben el archivo PDF pero dejan el perfil vacio o incompleto. Esto hace que el algoritmo no te detecte como candidato potencial, aunque tu CV sea excelente. La diferencia entre ser contactado o no esta en tener el perfil 100% completo.
...
4. Postula dentro de las primeras 48 horas: Las ofertas reciben la mayoria de postulaciones en los primeros dias. Postular temprano aumenta tu visibilidad.

5. Personaliza segun la oferta: Si bien este CV esta optimizado para tu area, puedes ajustar el resumen profesional para cada postulacion especifica.',

        'email_footer' => 'Te deseamos mucho exito en tu busqueda laboral. Recuerda que un CV optimizado es solo el primer paso: la clave esta en como lo utilizas en cada plataforma.',
    ];
