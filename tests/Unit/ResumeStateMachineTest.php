...
{
    public function test_draft_can_transition_to_paid_or_failed(): void
    {
    ...
    public function test_paid_can_transition_to_processing_delivered_or_failed(): void
    {
    ...
    public function test_processing_can_transition_to_delivered_or_failed(): void
    {
    ...
    public function test_failed_can_retry_to_processing_or_recover(): void
    {
